/**
 * QBTC-UNIFIED - Dashboard Mock Server
 * Servidor simulado con soporte completo para el dashboard de métricas
 */
...
app.get('/', (req, res) => {
  res.json({
    name: 'Leonardo Consciousness Quantum Engine (DASHBOARD MOCK)',
    version: '2.0.0',
    status: 'ACTIVE',
  ...
  res.json({
    ...
    system: {
      ...
      components: {
        ...
        dashboard: dashboardConfig.isConfigured
      }
    },
    trading: {
      enabled: true,
...
const server = app.listen(PORT, HOST, () => {
  console.log(`🚀 QBTC-UNIFIED Dashboard Mock Server running at http://${HOST}:${PORT}`);
